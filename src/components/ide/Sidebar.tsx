    ...
    return (
      <div>
        <button
          ...
          className="group flex w-full items-center gap-1 rounded px-1.5 py-[5px] text-left font-mono text-[13px] text-foreground hover:bg-hover transition-colors"
...
function ListView({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <motion.div
        className="ide-scrollbar flex-1 overflow-y-auto py-1"
        initial="hidden"
        animate="show"
        variants={{
          hidden: {},
